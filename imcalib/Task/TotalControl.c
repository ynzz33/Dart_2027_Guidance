...
void Vofa(void)
{
	...
	lqi_ctrl.attitude_error_rad[0],
	lqi_ctrl.attitude_error_rad[1],
	lqi_ctrl.attitude_error_rad[2],
	lqi_ctrl.torque_cmd_Nm[0],
	lqi_ctrl.torque_cmd_Nm[1],
	lqi_ctrl.torque_cmd_Nm[2],
	lqi_ctrl.torque_achieved_Nm[0],
	lqi_ctrl.torque_achieved_Nm[1],
	lqi_ctrl.torque_achieved_Nm[2],
	lqi_ctrl.servo_cmd_deg[0],
	lqi_ctrl.servo_cmd_deg[1],
	lqi_ctrl.servo_cmd_deg[2],
	lqi_ctrl.servo_cmd_deg[3],
	// IMU_Data.Velocity[Body][NOW][X],
	// IMU_Data.Velocity[Body][NOW][Y],
	// IMU_Data.Velocity[Body][NOW][Z],
	// IMU_Data.Velocity[World][NOW][PITCH],
	// IMU_Data.Velocity[World][NOW][ROLL],
	// IMU_Data.Velocity[World][NOW][YAW],
	...
	(ADC_Voltage_Real)*1000+Vision_Rx_Data.x[NOW],
