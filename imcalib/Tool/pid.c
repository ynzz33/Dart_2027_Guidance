...
// //镖体1
    ...
    PID_struct_init(&surface_control_pid[Angle][YAW]   ,POSITION_PID,150,4,1.85f,0.00f,0.00f,0.3f,0.3f);
    ...
    PID_struct_init(&surface_control_pid[Gyro][YAW]    ,POSITION_PID,80,4,0.70f,0.00f,0.00f,0.3f,0.3f);
